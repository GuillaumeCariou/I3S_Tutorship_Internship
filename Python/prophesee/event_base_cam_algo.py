...
def parse_args():
    ...
    parser.add_argument('--min-size', dest='min_size', type=int,
                        default=10, help='Minimal size of an object to track.')
    parser.add_argument('--max-size', dest='max_size', type=int,
                        default=300, help='Maximal size of an object to track.')
...
def main():
    ...
    interface = mvd_core.HalDeviceInterface(device, 1e-3, 0)
